...
# 작업예정 3 9월8일 renew
DA config 및 파라미터 수정완료 그러나,,,, 윈도우라는 장벽에 막힘.. 결국 우분투  만듦

*** 질문 1
이게 왜인지모르겟는데 target data 그러니까 domain adaptation 할 데이터셋에도 annotation (lable)파일이 필요함 
-> 그래서 만듦,,, infer해서,,, anno 파일 만듦
근데 그러면 그냥 train파일을,,, 학습하면... 되는거 아닌교.... DA를.,, 흐음...,, 물론 목적이 DA니깐... 하긴 하겠다만,,, 쩝접,,,
